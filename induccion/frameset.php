...
<html>
<head>
<title>Administraci&oacute;n modulo de Contenido</title>
...
<frameset cols="200,1*" frameborder="NO" border="0" framespacing="0" rows="*">
	...
	<?php
	echo "<frame name='menu' src='menu.php?id_adm=".$_REQUEST['id_adm']. " 'frameborder='NO' noresize>";
	
	?>
  <frame name="centro" src="personalizar.php" noresize frameborder="NO">
