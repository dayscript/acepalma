...
<table width="1200" height="927" border="0" align="center" cellpadding="0" cellspacing="0" id="Tabla_01">
	...
	<tr>
       ...
       <form action="cuestionario10b.php" method="post"> 
	...
	<tr>
		...
		<td><a href="politica_horario_santa_marta3.php"><img src="images/cuestionario1_04.jpg" width="78" height="63" alt=""></a></td>
		<td>
         <?php
