...
<table width="1200" height="927" border="0" align="center" cellpadding="0" cellspacing="0" id="Tabla_01">
	...
	<tr>
		<td colspan="3">
		  <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1200" height="773">
		    <param name="movie" value="images/fedeplama_02.swf">
		    ...
		    <!--[if !IE]>-->
		    <object type="application/x-shockwave-flash" data="images/fedeplama_02.swf" width="1200" height="773">
		      <!--<![endif]-->
		      <param name="quality" value="high">
		      <param name="wmode" value="opaque">
		      <param name="swfversion" value="11.2.0.0">
	...
	<tr>
		<td>
			<img src="images/fedeplama_03.jpg" width="1055" height="63" alt=""></td>
		<td><a href="la_agroindustria.php"><img src="images/fedeplama_04.jpg" width="78" height="63" alt=""></a></td>
		<td><a href="cenipalma.php"><img src="images/fedeplama_05.jpg" width="67" height="63" alt=""></a></td>
	</tr>
</table>
